          ...
          <MDBContainer fluid>
              <MDBRow>
                  <MDBCol md='3' className="border-right border-light" style={{paddingTop : "30px"}}>
                    {this.state.topics.map((topic) => <a href="#" onClick={() => this.setState({ selectedTopic: topic })}> {topic} <br></br></a>)}
                  </MDBCol>
                  <MDBCol md='9' style={{paddingTop : "30px"}}>
                    <form>
                    {
                        this.state.questions.map((question) => {
                            if(question.topic === this.state.selectedTopic) return (
                                <div>
                        ...
                        })}
                        {
                            index==0 
                            ? 
                                <strong>No questions available.<br></br></strong> 
                            : 
