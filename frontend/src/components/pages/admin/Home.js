  ...
  return (
    ...
    <MDBRow className="border d-flex align-items-center" style={{height: "15vh"}}>
        <MDBCol md='12' className="text-center">
          <h1 className="text-primary display-4" style={{fontSize: "50px"}}>Welcome {userData.user.username}</h1>
            <h1 className="text-muted display-6" style={{fontSize: "15px"}}>All the best!</h1>
        </MDBCol>
    </MDBRow>
